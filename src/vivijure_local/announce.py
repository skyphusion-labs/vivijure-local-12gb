...
Env: ANNOUNCE_BACKEND (default http://vivijure-local-12gb:8000), TUNNEL_TOKEN (set => named tunnel).
...
def main() -> int:
    backend = os.environ.get("ANNOUNCE_BACKEND", "http://vivijure-local-12gb:8000")
