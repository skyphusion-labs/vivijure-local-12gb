...
**Conditions.** Container `ghcr.io/skyphusion-labs/vivijure-local-backend:proof-12gb-ssh` (the pre-rename package name; image since deleted post-teardown), built from
