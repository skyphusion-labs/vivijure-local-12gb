...
- Full LTX-Video image-to-video render needs a 12GB-class GPU + `docker-compose.yml`
  and is not runnable on this CPU VM.

Verified in this environment: `pytest` -> 113 passed.
