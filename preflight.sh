#!/usr/bin/env bash
# vivijure-local-12gb preflight: CHECK (never install) the host prerequisites this backend needs, and
...
echo "vivijure-local-12gb preflight (checks only; installs nothing)"
echo "==========================================================="
